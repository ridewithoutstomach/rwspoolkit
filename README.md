...
- **Atlas Scientific Wi-Fi Pool Kit V1.3** (Adafruit Feather Huzzah ESP8266)
...
> **ESP32 version**: For the Pool Kit V1.8 (Adafruit HUZZAH32), see [rwspoolkit-esp32](https://github.com/ridewithoutstomach/rwspoolkit-esp32)

## Setup

### 1. Flash firmware

Upload the sketch to the ESP8266 using the Arduino IDE (see "Board & Libraries" section below).
...
The EZO sensor circuits (pH, ORP, RTD) ship in **UART mode** by default. They must be switched to **I2C mode** for the Pool-Kit. Use the `EZO_Switch_to_I2C` sketch (located in the parent folder).
...
- Install **ESP8266 Board Package** (Board Manager → search "esp8266")
- Select board: `Adafruit Feather HUZZAH ESP8266`
...
### Included in ESP8266 Board Package

- `ESP8266WiFi.h`, `ESP8266WebServer.h`, `ESP8266HTTPClient.h`, `ESP8266mDNS.h`
...
- `NewPoolKit_v6.3_GIT.ino` — Setup, loop, global variables, EZO sequencer
